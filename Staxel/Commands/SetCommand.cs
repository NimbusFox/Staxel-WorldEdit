...
namespace NimbusFox.WorldEdit.Staxel.Commands {
    public class SetCommand : ICommandBuilder {
        public string Execute(string[] bits, Blob blob, ClientServerConnection connection, ICommandsApi api,
            ...
            try {
                ...
                WorldEditManager.Set(player, newCode, out tileCount, out result);
        ...
        public string Usage => "mods.nimbusfox.worldedit.command.set.description";
